 ...
 * 		 필드(하위개념)
 * 	동사 : 메서드
 * 		 연관성있는 동일한 역할의 메서드가 많으면 클래스로 묶는다.
 * 
 * 2) MVC(역할)-- view-Controller-Model
 * Model:데이터베이스 제어(Dao)
 * View: 화면, 입출력
...
/*
 * 클래스: 설계도
 * 객체: 셀계도로 만들어진 실체(object, instance)
 */
public class FruitMain {
	public static void main(String[] args) {
		FruitSeller seller = new FruitSeller(200);
